...
<a
  ...
  class="group fixed bottom-6 right-6 z-50 inline-flex items-center gap-2 rounded-full
         px-4 py-2.5 text-sm font-medium fk-glass border-white/10
...
>
  ...
  <span class="fk-gradient-text">{label}</span>
  <svg width="11" height="11" viewBox="0 0 12 12" fill="none"
    class="shrink-0 opacity-40 group-hover:opacity-70 -translate-x-0.5 group-hover:translate-x-0 transition-all duration-200"
  >
